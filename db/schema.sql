...
(
  ...
  INSERT INTO users
    ( displayName, email, password, icon, color)
  VALUES
    ('External', '', '', NULL, ""),
    ('Susan', 'susan@test.com', 'susanpw', "Tim", '#9665D8'),
    ('Cat', 'cat@test.com', 'catkrspw', "Carl" , '#04D5FB'),
    ('Mandy', 'mandy@test.com', 'mandytpw', "Zach", '#9FA1A0'),
    ('Cynthia', 'cynthia@test.com', 'cynthiapw', "Carl", '#4481D8');
    ...
    (
      ...
      (
        ...
        INSERT INTO quizScores
           ( quizId, userId, questionId, displayName, icon, color, correct)
        VALUES
          ( 1, 1, 10, "Susan", "Tim", '#9665D8', 1),
          ( 1, 1, 11, "Susan", "Tim", '#9665D8', 1),
          ( 1, 1, 12, "Susan", "Tim", '#9665D8', 0),
          ( 1, 1, 13, "Susan", "Tim", '#9665D8', 1),
          ( 1, 1, 14, "Susan", "Tim", '#9665D8', 1),
          ( 1, 2, 10, "Badger", "Carl", '#9665D8', 1),
          ( 1, 2, 11, "Badger", "Carl", '#9665D8', 0),
          ( 1, 2, 12, "Badger", "Carl", '#9665D8', 1),
          ( 1, 2, 13, "Badger", "Carl", '#9665D8', 1),
          ( 1, 2, 14, "Badger", "Carl", '#9665D8', 1),
          ( 1, 3, 10, "Mandy", "Zack", '#9665D8', 1),
          ( 1, 3, 11, "Mandy", "Zack", '#9665D8', 0),
          ( 1, 3, 12, "Mandy", "Zack", '#9665D8', 0),
          ( 1, 3, 13, "Mandy", "Zack", '#9665D8', 1),
          ( 1, 3, 14, "Mandy", "Zack", '#9665D8', 1),
          ( 1, 4, 10, "Cynthia", "Jon", '#9665D8', 1),
          ( 1, 4, 11, "Cynthia", "Jon", '#9665D8', 1),
          ( 1, 4, 12, "Cynthia", "Jon", '#9665D8', 0),
          ( 1, 4, 13, "Cynthia", "Jon", '#9665D8', 1),
          ( 1, 4, 14, "Cynthia", "Jon", '#9665D8', 1),
          ( 2, 3, 20, "Mandy", "Tim", '#9665D8', 1),
          ( 2, 3, 21, "Mandy", "Tim", '#9665D8', 1),
          ( 2, 3, 22, "Mandy", "Tim", '#9665D8', 0),
          ( 2, 3, 23, "Mandy", "Tim", '#9665D8', 1),
          ( 2, 3, 14, "Mandy", "Tim", '#9665D8', 1),
          ( 2, 4, 20, "CRich", "Zack", '#9665D8', 1),
          ( 2, 4, 21, "CRich", "Zack", '#9665D8', 0),
          ( 2, 4, 22, "CRich", "Zack", '#9665D8', 0),
          ( 2, 4, 23, "CRich", "Zack", '#9665D8', 1),
          ( 2, 4, 14, "CRich", "Zack", '#9665D8', 1); 
